...
print(f"""Once upon a time there was a {adjective1} {noun1} named {name1}.""")
...
print(f"""{name3} couldn't stop {action2} so {name1} decided to pay attention to {lesson1} by a forgetable teacher.""")
print(f"""{name1} needed to get out that class, so they {action3} to get detention. While walking to detention, they saw an escape route through {noun3}, leaving that {adjective2} school.""")